...
# Libs
LIBS += -lplayerc -L/usr/local/lib64 -pthread -lopencv_core -lopencv_highgui
...
SOURCES += \
    ...
    src/PlayerStageControl/player/behavior/basics/behavior_mapping.cc
...
HEADERS += \
    ...
    src/PlayerStageControl/player/behavior/basics/behavior_mapping.hh
